...
class Recording extends Component {
  ...
  componentDidMount() {
    AudioRecorder.requestAuthorization().then(isAuthorised => {
      ...
      this.prepareRecordingPath(this.state.audioPath+ '/test_'+ new Date().getTime()+'.aac');
  ...
  async stop() {
    ...
    try {
      ...
      Constant.timeConst= this.state.currentTime;
      Constant.audioPath =filePath;
  ...
  async record() {
    ...
    // Document.save(audioPath), {type: 'audio', album: 'CustomFolder'}
    ...
    return (
      <View style={styles.container}>
        {/* <View style={styles.controls}> */}
          ...
          <TouchableOpacity style={{alignSelf:'flex-end'}} onPressIn={()=> this.record()} onPressOut={()=> this.stop()} >
